package com.skripsi.mendoanapps.util
    ...
    class CustomProgressDialog(context: Context) {
        ...
        init {
            ...
            setColorFilter(
                ...
                ResourcesCompat.getColor(context.resources, R.color.colorDefault, null)
            )
        ...
        class CustomDialog(context: Context) : Dialog(context, R.style.CustomDialogTheme) {
            init {
                ...
                window?.decorView?.rootView?.setBackgroundResource(R.color.colorwhiteblueshade)
